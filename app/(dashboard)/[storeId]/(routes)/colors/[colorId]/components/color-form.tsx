...
const ColorForm: React.FC<ColorFormProps> = ({ initialData }) => {
    ...
    const toastTitleMessage = initialData ? "Color updated" : "Color created";
    const toastDescriptionMessage = initialData ? "Color updated successfully" : "Color created successfully.";
    ...
    const onDelete = async () => {
        try {
            ...
            toast({
                variant: 'destructive',
                title: "Uh oh! Something went wrong.",
                description: 'Problem with the process.'
            });
